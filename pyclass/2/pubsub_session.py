...
post_message('raymondh', '#python news: pypy5.0 released')
...
print
print "=======TWEETS BY ramondh======="
pprint(posts_by_user('raymondh'))

print
print "=======TWEETS FOR davin======="
...
print
print "=======WHO FOLLOWS raymondh ======="
pprint(who_follows_you('raymondh'))

print
print "=======WHO DOES davin FOLLOW ======="
pprint(who_you_follow('davin'))
